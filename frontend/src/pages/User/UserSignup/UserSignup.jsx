...
const UserSignup = () => {
  ...
  return (
    <AuthLayout role="user">
      ...
      <p className="text-sm text-gray-500 mb-7">Start selling your waste today</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-11 pl-8 pr-3 rounded-xl border border-gray-200 bg-gray-50 text-sm focus:outline-none focus:ring-2 focus:ring-[#37B943] focus:bg-white transition"
            />
          </div>
          <input
            type="text" name="LastName" placeholder="Last name"
            value={formData.LastName} onChange={handleChange}
            className="w-full h-11 px-3 rounded-xl border border-gray-200 bg-gray-50 text-sm focus:outline-none focus:ring-2 focus:ring-[#37B943] focus:bg-white transition"
          />
        </div>
        ...
        <div className="relative">
          ...
          <input
            type={showPw ? "text" : "password"} name="password" placeholder="Password (min 6 chars)"
      ...
      <p className="text-center text-xs text-gray-500 mt-6">
        ...
        <Link to="/user/login" className="text-[#37B943] font-semibold hover:underline">Sign In</Link>
      </p>
    </AuthLayout>
  );
};
